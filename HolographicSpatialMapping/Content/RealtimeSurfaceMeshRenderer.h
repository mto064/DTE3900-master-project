...
namespace WindowsHolographicCodeSamples
{
    ...
    public:
        ...
        // added
        std::map<Platform::Guid, MeshData> GetMeshCollection();
        Windows::Perception::Spatial::SpatialCoordinateSystem^ m_worldCoordSystem;
    ...
    private:
        ...
        double                                          m_maxTrianglesPerCubicMeter = 20000.0;
